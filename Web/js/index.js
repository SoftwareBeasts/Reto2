$(function(){
    if ($("#boton-seleccion-seleccionado").length==0){
        ...
        $("#contenedor-preguntas-index").load("php/generar-preguntas.php",$("#boton-seleccion-seleccionado").attr("name"));
    };
});
...
function cambiarBusqueda(){
    ...
    $("#contenedor-preguntas-index").post("php/generar-preguntas.php",{modoBusqueda : $("#boton-seleccion-seleccionado").attr("name")});
}
